...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Bootstrap-only landing page (no Tailwind classes) --}}
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white text-dark">
            ...
            <div class="container py-3">
                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                    ...
                    <div class="d-flex gap-2 align-items-center justify-content-lg-end">
                        <span class="badge text-bg-danger border-0 rounded-pill px-3 py-2" style="background:rgba(255,255,255,.12)!important;">
                            Secure • Corporate • Audit-friendly
                        </span>
                    </div>
                </div>
        ...
        <main id="content">
            <section
                style="background:linear-gradient(to bottom, rgba(11,61,145,.12), #ffffff 55%, rgba(193,18,31,.06));"
            >
                <div class="container py-5">
                    <div class="row align-items-start g-4">
                        <div class="col-lg-7">
                            ...
                            <div class="row g-3 mt-4">
                                <div class="col-md-6">
                                    <div class="card h-100 border-0 shadow-sm" style="background:#ffffff;">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center gap-3">
                                                <span class="d-inline-grid" style="width:40px;height:40px;border-radius:.75rem;background:rgba(11,61,145,.10);border:1px solid rgba(11,61,145,.18);place-items:center;">
                                                    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <div class="container">
                    <div class="card shadow-sm border-0" style="background:#ffffff;">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <div class="mt-4 p-3 rounded-3" style="background:rgba(11,61,145,.05);border:1px solid rgba(11,61,145,.20);">
                                <div class="d-flex gap-3 align-items-start">
                                    <span class="d-inline-grid" style="width:36px;height:36px;border-radius:.85rem;background:rgba(11,61,145,.10);border:1px solid rgba(11,61,145,.18);place-items:center;color:#0B3D91;">
                                        <svg viewBox="0 0 24 24" width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path d="M12 2l9 5v10l-9 5-9-5V7l9-5Z" stroke="#0B3D91" stroke-width="1.7"/>
                            ...
                            <div class="card shadow-sm border-0" style="background:#ffffff;">
                                <div class="card-body p-4 p-lg-5">
                                    ...
                                    <div class="mt-4 p-3 rounded-3" style="border:1px solid rgba(11,61,145,.20);background:rgba(11,61,145,.05);">
                                        <div class="fw-semibold">Ready for corporate workflows</div>
                                        <div class="small text-muted">
                                            Add real routes later—this page is structured for smooth integration.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-start g-4">
                                <div class="col-lg-6">
                                    ...
                                    <p class="text-white-50 mb-0">
                                        For support, system access, and process guidance.
                                    </p>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row g-3">
        ...
        <footer class="py-4 border-top">
            <div class="container d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
                ...
                <div class="small text-muted">
                    Designed for corporate-friendly access control.
                </div>
            </div>
        </footer>
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-white text-slate-900 antialiased">
        <a href="#content" class="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded-md focus:bg-white focus:px-4 focus:py-2 focus:text-slate-900 focus:shadow">
            Skip to content
        </a>im

        <div class="relative overflow-hidden">
            <div class="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#0B3D91]/10 via-white to-[#C1121F]/5"></div>
            <div class="pointer-events-none absolute -left-24 top-0 h-[520px] w-[520px] rounded-full bg-[#0B3D91]/10 blur-2xl"></div>
            <div class="pointer-events-none absolute -right-24 top-20 h-[520px] w-[520px] rounded-full bg-[#C1121F]/10 blur-2xl"></div>
            ...
            <header class="relative">
                    ...
                    <div class="mx-auto max-w-6xl px-4 py-3">
                        <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex items-center gap-3">
                                <div class="grid h-10 w-10 place-items-center rounded-xl bg-white/10 ring-1 ring-white/20">
                                    <svg viewBox="0 0 24 24" class="h-6 w-6 text-white" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                        <path d="M12 2l8 4v6c0 5-3.5 9.7-8 10-4.5-.3-8-5-8-10V6l8-4Z" stroke="currentColor" stroke-width="1.6" />
                                        <path d="M8.5 11.2l2.2 2.3 4.9-5.3" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            ...
                            <div class="flex items-center justify-between gap-3 sm:justify-end">
                                <div class="rounded-full bg-white/10 px-3 py-1 text-xs font-medium text-white/90 ring-1 ring-white/20">
                                    Secure • Corporate • Audit-friendly
                                </div>
                            </div>
                        </div>
                ...
                <div class="mx-auto max-w-6xl px-4 py-4">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            <span class="inline-flex items-center rounded-full bg-[#C1121F]/10 px-3 py-1 text-xs font-semibold text-[#8B0F14] ring-1 ring-[#C1121F]/25">
                                TRS - VRS
                            </span>
                            <div>
                        ...
                        <nav class="flex items-center gap-2">
                            <a href="#modules" class="rounded-md px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
                                Modules
                            </a>
                            <a href="#how-it-works" class="rounded-md px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
                                How it works
                            </a>
                            <a href="#contact" class="rounded-md bg-slate-900 px-3 py-2 text-sm font-semibold text-white hover:bg-slate-800">
                                Contact
                            </a>
                        </nav>
                    </div>
                ...
                <div class="h-2 w-full bg-gradient-to-r from-[#0B3D91] via-[#0B3D91] to-[#C1121F]"></div>
            </header>

            <main id="content" class="relative">
                <section class="mx-auto max-w-6xl px-4 pb-12 pt-10 sm:pb-16 sm:pt-14">
                    <div class="grid gap-8 lg:grid-cols-12 lg:items-start">
                        <div class="lg:col-span-7">
                            <div class="inline-flex items-center gap-2 rounded-full bg-[#0B3D91]/10 px-3 py-1 ring-1 ring-[#0B3D91]/20">
                                <span class="h-2 w-2 rounded-full bg-[#C1121F]"></span>
                                <span class="text-xs font-semibold tracking-wide text-[#0B3D91]">WELCOME / SELAMAT DATANG</span>
                            </div>
                            ...
                            <div class="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
                                <a href="#registration" class="inline-flex items-center justify-center rounded-md bg-[#0B3D91] px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#0A346F] focus:outline-none focus:ring-2 focus:ring-[#0B3D91]/40">
                                    Start Registration
                                </a>
                                <a href="#how-it-works" class="inline-flex items-center justify-center rounded-md bg-white px-5 py-3 text-sm font-semibold text-[#0B3D91] ring-1 ring-[#0B3D91]/30 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#0B3D91]/25">
                                    View Process
                                </a>
                            </div>
                            ...
                            <div class="mt-8 grid gap-3 sm:grid-cols-2">
                                <div class="rounded-xl bg-white p-4 ring-1 ring-slate-200">
                                    <div class="flex items-center gap-3">
                                        <span class="grid h-9 w-9 place-items-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20">
                                            <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path d="M12 1.8 2.8 6.7v6.4c0 5.2 3.6 9.3 9.2 9.9 5.6-.6 9.2-4.7 9.2-9.9V6.7L12 1.8Z" stroke="currentColor" stroke-width="1.7"/>
                                            </svg>
                                        </span>
                                        <div>
                                            <div class="text-sm font-semibold">Verified Entry</div>
                                            <div class="text-xs text-slate-600">Clear visitor identity & purpose.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="rounded-xl bg-white p-4 ring-1 ring-slate-200">
                                    <div class="flex items-center gap-3">
                                        <span class="grid h-9 w-9 place-items-center rounded-lg bg-[#C1121F]/10 text-[#8B0F14] ring-1 ring-[#C1121F]/20">
                                            <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path d="M12 2v6l4 2" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M21 12a9 9 0 1 1-9-9" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>
                                            </svg>
                                        </span>
                                        <div>
                                            <div class="text-sm font-semibold">Faster Check-in</div>
                                            <div class="text-xs text-slate-600">Reduce manual paperwork and queues.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="lg:col-span-5">
                            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                                <div class="flex items-start justify-between gap-4">
                                    <div>
                                        <div class="text-sm font-semibold text-slate-900">Operational Highlights</div>
                                        <div class="mt-1 text-xs text-slate-600">Designed for audit trails and reporting.</div>
                                    </div>
                                    <span class="rounded-full bg-[#C1121F]/10 px-3 py-1 text-xs font-semibold text-[#8B0F14] ring-1 ring-[#C1121F]/20">
                                        Ready
                                    </span>
                                </div>
                                <div class="mt-5 grid gap-3">
                                    <div class="flex items-start gap-3 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                        <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20">
                                            1
                                        </span>
                                        <div>
                                            <div class="text-sm font-semibold">Capture details</div>
                                            <div class="text-xs text-slate-600">Visitor and vehicle information.</div>
                                        </div>
                                    </div>
                                    <div class="flex items-start gap-3 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                        <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20">
                                        ...
                                        <div>
                                            <div class="text-sm font-semibold">Submit for review</div>
                                            <div class="text-xs text-slate-600">Consistent records for the team.</div>
                                        </div>
                                    </div>
                                    <div class="flex items-start gap-3 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                        <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20">
                                        ...
                                        <div>
                                            <div class="text-sm font-semibold">Check-in on arrival</div>
                                            <div class="text-xs text-slate-600">Quick verification at the gate.</div>
                                        </div>
                                    </div>
                                </div>

                                <div class="mt-6 rounded-xl bg-[#0B3D91] p-4">
                                    <div class="flex items-start gap-3">
                                        <span class="mt-0.5 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 ring-1 ring-white/20">
                                            <svg viewBox="0 0 24 24" class="h-5 w-5 text-white" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path d="M12 22s8-4 8-10V6l-8-4-8 4v6c0 6 8 10 8 10Z" stroke="currentColor" stroke-width="1.6"/>
                                            </svg>
                                        </span>
                                        <div class="text-white">
                                            <div class="text-sm font-semibold">Compliance mindset</div>
                                            <div class="text-xs text-white/80">Clear process for safer access control.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="registration" class="mx-auto max-w-6xl px-4 pb-12 sm:pb-16">
                    <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 sm:p-8">
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                                <h3 class="text-2xl font-bold tracking-tight">Start Registration</h3>
                                <p class="mt-2 text-sm text-slate-600">
                                    This landing page is a corporate overview. When your registration routes are ready,
                                    the CTAs can be wired to your existing controllers.
                                </p>
                            </div>
                            <div class="flex gap-2">
                                <a href="#modules" class="inline-flex items-center justify-center rounded-md bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">
                                    Explore Modules
                                </a>
                                <a href="#contact" class="inline-flex items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-semibold text-slate-900 ring-1 ring-slate-200 hover:bg-slate-50">
                                    Contact Helpdesk
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 grid gap-4 lg:grid-cols-3">
                            <div class="rounded-xl bg-slate-50 p-5 ring-1 ring-slate-100">
                                <div class="flex items-center gap-3">
                                    <span class="grid h-10 w-10 place-items-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20">
                                        <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path d="M16 11V7a4 4 0 1 0-8 0v4" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>
                                            <path d="M8 21h8a4 4 0 0 0 0-8H8a4 4 0 0 0 0 8Z" stroke="currentColor" stroke-width="1.7"/>
                                        </svg>
                                    </span>
                                    <div>
                                        <div class="text-sm font-semibold">Visitor Details</div>
                                        <div class="text-xs text-slate-600">Name, ID, purpose, host.</div>
                                    </div>
                                </div>
                                <p class="mt-3 text-sm text-slate-700">
                                    Collect accurate visitor information for consistent processing.
                                </p>
                            </div>
                            <div class="rounded-xl bg-slate-50 p-5 ring-1 ring-slate-100">
                                <div class="flex items-center gap-3">
                                    <span class="grid h-10 w-10 place-items-center rounded-lg bg-[#C1121F]/10 text-[#8B0F14] ring-1 ring-[#C1121F]/20">
                                        <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path d="M3 13l2-6h14l2 6" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M7 19a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" stroke="currentColor" stroke-width="1.7"/>
                                            <path d="M17 19a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" stroke="currentColor" stroke-width="1.7"/>
                                            <path d="M3 13h18v3H3v-3Z" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/>
                                        </svg>
                                    </span>
                                    <div>
                                        <div class="text-sm font-semibold">Vehicle Info</div>
                                        <div class="text-xs text-slate-600">Plate number, vehicle type.</div>
                                    </div>
                                </div>
                                <p class="mt-3 text-sm text-slate-700">
                                    Record vehicle details to support access control at the gate.
                                </p>
                            </div>
                            <div class="rounded-xl bg-slate-50 p-5 ring-1 ring-slate-100">
                                <div class="flex items-center gap-3">
                                    <span class="grid h-10 w-10 place-items-center rounded-lg bg-slate-900/10 text-slate-900 ring-1 ring-slate-900/20">
                                        <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    ...
                                    <div>
                                        <div class="text-sm font-semibold">Records & Reporting</div>
                                        <div class="text-xs text-slate-600">Audit trail and consistent logs.</div>
                                    </div>
                                </div>
                                <p class="mt-3 text-sm text-slate-700">
                                    Centralize submissions so teams can review and report quickly.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section id="how-it-works" class="mx-auto max-w-6xl px-4 pb-12 sm:pb-16">
                    <div class="grid gap-6 lg:grid-cols-2 lg:items-start">
                        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 sm:p-8">
                            <h3 class="text-2xl font-bold tracking-tight">How it works</h3>
                            <p class="mt-2 text-sm text-slate-600">
                                A simple flow that supports corporate operations and consistent data capture.
                            </p>

                            <ol class="mt-6 space-y-4">
                                <li class="flex gap-4 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20 font-bold">
                                        1
                                    </span>
                                    <div>
                                        <div class="text-sm font-semibold">Provide visitor & vehicle details</div>
                                        <div class="text-xs text-slate-600">Purpose, host, and plate information.</div>
                                    </div>
                                </li>
                                <li class="flex gap-4 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20 font-bold">
                                    ...
                                    <div>
                                        <div class="text-sm font-semibold">Submit registration</div>
                                        <div class="text-xs text-slate-600">A structured submission for easier review.</div>
                                    </div>
                                </li>
                                <li class="flex gap-4 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20 font-bold">
                                    ...
                                    <div>
                                        <div class="text-sm font-semibold">Receive access status</div>
                                        <div class="text-xs text-slate-600">Keep records for the relevant gate team.</div>
                                    </div>
                                </li>
                                <li class="flex gap-4 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20 font-bold">
                                    ...
                                    <div>
                                        <div class="text-sm font-semibold">Check-in at arrival</div>
                                        <div class="text-xs text-slate-600">Verify and log attendance efficiently.</div>
                                    </div>
                                </li>
                            </ol>
                        </div>
                        ...
                        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 sm:p-8">
                            <h3 class="text-2xl font-bold tracking-tight">Corporate Modules</h3>
                            <p class="mt-2 text-sm text-slate-600">
                                Built to match the way government and corporate teams track visitor access.
                            </p>
                            <div id="modules" class="mt-6 grid gap-4 sm:grid-cols-2">
                                <div class="rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <div class="text-sm font-semibold">Visitor Register</div>
                                    <div class="mt-1 text-xs text-slate-600">Capture visitor identity and host information.</div>
                                </div>
                                <div class="rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <div class="text-sm font-semibold">Vehicle Registry</div>
                                    <div class="mt-1 text-xs text-slate-600">Store plate number and vehicle type.</div>
                                </div>
                                <div class="rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <div class="text-sm font-semibold">Policy & Rules</div>
                                    <div class="mt-1 text-xs text-slate-600">Standardize data and compliance checks.</div>
                                </div>
                                <div class="rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
                                    <div class="text-sm font-semibold">Audit-friendly Logs</div>
                                    <div class="mt-1 text-xs text-slate-600">Consistent records for review and reporting.</div>
                                </div>
                            </div>

                            <div class="mt-6 rounded-xl border border-[#0B3D91]/20 bg-[#0B3D91]/5 p-4">
                                <div class="flex items-start gap-3">
                                    <span class="mt-0.5 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-[#0B3D91]/10 text-[#0B3D91] ring-1 ring-[#0B3D91]/20">
                                        <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path d="M12 2l9 5v10l-9 5-9-5V7l9-5Z" stroke="currentColor" stroke-width="1.7" />
                                    ...
                                    <div>
                                        <div class="text-sm font-semibold text-slate-900">Next step</div>
                                        <div class="text-xs text-slate-600">
                                            If you add dedicated routes/pages (e.g. visitor form, vehicle form),
                                            I can wire these CTAs to your controllers.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="contact" class="mx-auto max-w-6xl px-4 pb-10 sm:pb-14">
                    <div class="rounded-2xl bg-[#0B3D91] p-6 shadow-sm sm:p-8">
                        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                            <div class="max-w-xl">
                                <h3 class="text-2xl font-bold tracking-tight text-white">Helpdesk / Pertanyaan</h3>
                            ...
                            <div class="grid gap-3 sm:grid-cols-2">
                                <div class="rounded-xl bg-white/10 p-4 ring-1 ring-white/15">
                                    <div class="text-xs font-semibold text-white/80">Email</div>
                                    <div class="mt-1 text-sm font-semibold text-white">helpdesk@your-agency.gov.my</div>
                                </div>
                                <div class="rounded-xl bg-white/10 p-4 ring-1 ring-white/15">
                                    <div class="text-xs font-semibold text-white/80">Phone</div>
                                    <div class="mt-1 text-sm font-semibold text-white">+60 3-0000 0000</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="relative">
                <div class="mx-auto max-w-6xl px-4 pb-10">
                    <div class="flex flex-col gap-3 border-t border-slate-200 pt-8 sm:flex-row sm:items-center sm:justify-between">
                        <div class="text-sm text-slate-600">
                            © {{ now()->year }} {{ config('app.name', 'Visitor Registration System') }}. All rights reserved.
                        </div>
                        <div class="text-xs text-slate-500">
                            Built with Laravel + Tailwind. Designed for corporate-friendly access control.
                        </div>
                    </div>
                </div>
            </footer>
